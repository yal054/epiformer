...
batch_size = 8 # 4 # using 4 NVIDIA GeForce RTX 3090 GPUs
warmup_epoches = 10
...
dataset_list = [HDF5Dataset(f_path, preprocess=True, if_log2=False, which = celltype_index) for f_path in infile_list[0:1]]
